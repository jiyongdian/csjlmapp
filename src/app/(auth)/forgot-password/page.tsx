...
function ForgotPasswordContent() {
  ...
  return (
    <AuthLayout
      ...
      onTransitionComplete={() => router.replace("/auth/login")}
    >
      {/* 标题控制 */}
      ...
      <div className="pt-2 text-sm text-white/45">
        记起密码了？{" "}
        <Link href="/auth/login" className="text-white underline decoration-white/30 underline-offset-4 hover:decoration-white/80 transition-colors">
          立即登录
        </Link>
      </div>
